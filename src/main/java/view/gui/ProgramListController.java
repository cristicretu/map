                ...
                new CompStmt(new AssignStmt("a", new ConstantValue(new IntValue(1))),
                    new CompStmt(new AssignStmt("b", new ConstantValue(new IntValue(2))),
                        new CompStmt(new AssignStmt("c", new ConstantValue(new IntValue(5))),
                            new CompStmt(
                                new SwitchStmt(
                                    new ArithExp('*', new VariableExp("a"), new ConstantValue(new IntValue(10))),
                                    new ArithExp('*', new VariableExp("b"), new VariableExp("c")),
                                    new ConstantValue(new IntValue(10)),
                                    new CompStmt(new PrintStmt(new VariableExp("a")),
                                        new PrintStmt(new VariableExp("b"))),
                                    new CompStmt(new PrintStmt(new ConstantValue(new IntValue(100))),
                                        new PrintStmt(new ConstantValue(new IntValue(200)))),
                                    new PrintStmt(new ConstantValue(new IntValue(300)))),
                                new PrintStmt(new ConstantValue(new IntValue(300))))))))));
